...
Update:
If you change contents of $(Basedir) template source files, you should rebuild HXPTemplate.fdz as following:
1) zip folder $(BaseDir)
2) rename archive to HXPTemplate.fdz
